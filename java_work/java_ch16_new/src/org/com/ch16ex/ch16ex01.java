...
public class ch16ex01 {
	...
	public static void main(String[] args) {
		  Vector<Saram> saramList = new Vector<Saram>();
	      saramList.addElement(new Saram(101, "kim","김길동", "kim@saram.com", 45));
	      saramList.addElement(new Saram(102, "lee","이길동2", "lee@saram.com", 27));
	      saramList.addElement(new Saram(103, "park","박길동3", "park@saram.com", 30));
	      saramList.addElement(new Saram(104, "hong","홍길동4", "hong@saram.com", 25));
	      saramList.addElement(new Saram(105, "jjang","장길동5", "jjang@saram.com", 33));
